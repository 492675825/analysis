...
public class GoldMaxEarningRateController {
    @Resource
    private GoldMaxEarningRateService goldMaxEarningRateService;
    ...
    public Map<String, Object> earningRate(){
        ...
        context.put("data",goldMaxEarningRateService.maxEarningRate());
        return context;
    }
}
